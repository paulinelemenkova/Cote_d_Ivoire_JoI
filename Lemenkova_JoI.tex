...
\begin{figure}[H]\centering
	...
	\caption{Topographic map of Côte d'Ivoire. Mapping: GMT. Source: authors.
	\label{fig1}}
\end{figure}  
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.7\textwidth}
         ...
         \label{fig:04a}
     \end{subfigure}
        \caption{Modified azimuth and sun angle degrees in hillshade of DTM of Kossou Lake, Côte d'Ivoire}
        \label{fig4}
\end{figure}
