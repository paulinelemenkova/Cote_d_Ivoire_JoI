...
The SAVI is a distance-based vegetation index which adjusts the NDVI for soil brightness where vegetation coverage is low in urban densely built-up areas and bare soil \cite{HUETE1988295}. The SAVI index is a more finer indicator, compared to NDVI, used to analyse the Landsat OLI/TIRS scene and assess whether the land coverage contains healthy green vegetation with correction on brightness with the majority of values lying in the diapason of -0.1 to 0.1, Figure \ref{fig09}. Thus, the main advantage of SAVI is the emphasised colour of the vegetation canopy corrected for soil brightness.
