...
The land cover types of Côte d'Ivoire are associated with the two major vegetation types of the West Africa -- forest and savanna. The separation between them passes circa parallel to the coast north off Bouak\'{e} \cite{Rougerie}, Figure \ref{fig1}. The vegetation types are controlled by the equatorial or subequatorial rainfall regime: long dry season is typical for the northern half of Côte d'Ivoire, where it eliminates forests and imposes the savannah, while tropical regime characterises the southern parts with dominating forests \cite{Tricart}. Favourable climatic and environmental setting of Côte d'Ivoire maintain active farming and agricultural activities which make it the world's largest cocoa producer \cite{Losch,Planhol,Smithetal2014,Laderach} and active exporter of food-producing crops \cite{Sawadogo}, e.g., coffee, bananas, pineapples and palm oil \cite{Pelissier}. 
