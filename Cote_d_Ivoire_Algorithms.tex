...
The land cover types of Côte d'Ivoire are associated with the two major vegetation types of the West Africa -- forest and savanna. The separation between them passes approximately parallel to the coast leaving Bouak\'{e} to the north \cite{Rougerie}, Figure \ref{fig1}. The vegetation types are controlled by the equatorial or subequatorial rainfall regime: long dry season is typical for the northern half of Côte d'Ivoire, where it eliminates the forest and imposes the savannah, while tropical regime characterises the southern parts with dominating forests \cite{Tricart}. Such environmental setting limits farming and agricultural activities which are mostly focused on cocoa \cite{Losch,Planhol,Smithetal2014,Laderach} and food-producing crops \cite{Sawadogo} due to the climatic suitability. 
