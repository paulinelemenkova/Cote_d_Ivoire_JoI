...
The vegetation index uses the arithmetics of bands in Red and NIR because plants absorbs Red and strongly reflect NIR waves. Using this fundamental property, the vegetation indices are used to evaluate vegetation health and assess vigour of plants in agricultural regions. The general NDVI lies in the diapason of -1 to +1, and the majority of values are restricted by the range of -0.1 to 0.5, Figure \ref{fig08}. Negative values of the NDVI correspond to water or very moist soil areas, as shown by beige to white colours in Figure \ref{fig08}, while higher NDVI values signify a dense vegetation canopy which is depicted by bright green in Figure \ref{fig08}. 
