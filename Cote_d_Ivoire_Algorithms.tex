...
\begin{equation}\label{eq:4}
ARVI=2.4*\dfrac{(NIR-Red)}{(NIR+Red+1)}
\end{equation}

It shows the regions of high atmospheric aerosol content with higher moisture. In comparison to NDVI, the ARVI adjusts and minimises the atmospheric scattering effects due to the blue light reflectance values, which also affect the reflectance in the red light \cite{134076}. 
