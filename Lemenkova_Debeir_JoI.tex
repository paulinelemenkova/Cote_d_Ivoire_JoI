...
\caption{Bands 3-4-5: near-infrared (B5) as red, red (B4) as green, and green (B3) as blue.}
\end{subfigure}%
\begin{subfigure}[b]{.6\textwidth}
\centering
\includegraphics[width=0.95\textwidth]{Fig_08b}
\caption{Natural color (a) and (b) color composites of bands 2-3-4. False color composite (c) and (d) visualization of bands 7-6-5}
\end{subfigure}%
}
\caption{Landsat 8 OLI image of Kossou Lake surroundings, Côte d'Ivoire. Mapping: RStudio. Source: authors.}
\end{figure}
