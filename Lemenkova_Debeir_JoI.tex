...
\subsubsection{Creating single band and composite maps}
...
\makebox[\textwidth][r]{\includegraphics[width=1.3\textwidth]{Bands_11_vert.jpg}}%
	\caption{Original individual 11 layers (raw bands) of the multi-spectral image Landsat-8 OLI/TIRS C1 'LC09\_L1TP\_197055\_20220111\_20220122\_02\_T1' in grayscale visualization: Ultra Blue (Band 1), Blue (Band 2), Green (Band 3), Red (Band 4), Near Infrared (NIR) (Band 5), Shortwave Infrared (SWIR) 1 (Band 6), Shortwave Infrared (SWIR) 2 (Band 7), Panchromatic (Band 8), Cirrus (Band 9), Thermal Infrared (TIRS) 1 (Band 10), Thermal Infrared (TIRS) 2 (Band 11). Plotting: R.}
	\label{fig1}
\end{figure} 
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         ...
         \label{fig:00a}
     \end{subfigure}
        \caption{\textbf{(a)}: Grayscale visualization of the Landsat OLI/TIRS image with enlarged fragment of Kossou Lake in SWIR, Band 6. Mapping: R. \textbf{(b)}: Enlarged cropped SRTM3 Void Filled DEM (NASA/NGA) overlayed on top of a hillshade. cmaps: 'turbo' and 'gist\_yarg'. Mapping: Python.}
        \label{fig0}
\end{figure}
