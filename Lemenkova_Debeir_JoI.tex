...
\Title{Satellite Image Processing by Python and R for Terrain Analysis of Côte d'Ivoire using Landsat 9 OLI/TIRS and SRTM DEM}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Satellite Image Processing by Python and R for Terrain Analysis of Côte d'Ivoire using Landsat 9 OLI/TIRS and SRTM DEM}
