...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         ...
         \label{fig:00a}
     \end{subfigure}
        \caption{Inspecting correlation between Landsat bands for selected Landsat-8 OLI/TIRS C1 bands in multispectral image \emph{LC09\_L1TP\_197055\_20220111\_20220122\_02\_T1\_B}.}
        \label{fig0}
\end{figure}
